...
import com.p3lb.tutuplapak.ActivityEditProduk;
import com.p3lb.tutuplapak.Config;
import com.p3lb.tutuplapak.MainActivity;
...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_row_produk, parent, false);
    ...
    public void onBindViewHolder (MyViewHolder holder,final int position){
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mIntent = new Intent(view.getContext(), ActivityEditProduk.class);
                ...
                mIntent.putExtra("harga_produk", mproductsList.get(position).getHarga_produk());
                mIntent.putExtra("jumlah_produk", mproductsList.get(position).getJumlah_produk());
